Feature: Login
  ...
  @Negative_Test
  Scenario: Verify that warning message is displayed when incorrect password is entered
    Given user is on the login page
  ...
  Scenario Outline: Login as <role> and verify <title> page title is correct
    ...
    Examples: drivers
      ...
      | driver | Fleet      | Vehicles Model  | Vehicle Model - Entities - System - Car - Entities - System |
    ...
    Examples: sales manager
      ...
      | sales manager | Fleet      | Vehicles Model  | All - Vehicle Model - Entities - System - Car - Entities - System |
